...
<body>
                            ...
                            <div class="col">
                                {{-- <form action="data_reg" method="POST"> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="idmutasi" id="idmutasi" value={{$mutasis[0]->id_mutasi}}>
                                        <input type="text" id="nomor_bukti" name="nomor_bukti" value="{{ $mutasis[0]->nomor_bukti}}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="tanggal_mutasi" type="text" value="{{ $mutasis[0]->tanggal}}" name="tanggal_mutasi" class="form-control"
                                            ...
                                            <div id="form-barang">
                                                @foreach ($detail_mutasis as $detail)
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" name="kode_barang" id="kode_barang">
                                                            ...
                                                            <option value="{{ $barang->kode_barang }} "{{ ($detail->kode_barang==$barang->kode_barang) ? 'selected' : '' }}>{{ $barang->kode_barang}} - {{$barang->nama_barang }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                                            </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" id="quantity" name="quantity" value="{{$detail->quantity}}" />
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <select class="form-control" name="indikator_barang" id="indikator_barang">
                                                                ...
                                                                <option value="Masuk" {{ ($detail->indikator=='Masuk') ? 'selected' : '' }}>Masuk</option>
                                                                <option value="Keluar" {{ ($detail->indikator=='Keluar') ? 'selected' : '' }}>Keluar</option>
                                                            </select>
                                                    ...
                                                    @endforeach
                                                        ...
                                                        <button class="btn btn-primary" id="btn-update-mutasi">Update</button>
                                                    {{-- </form> --}}
                                                </div>
                                            </div>
                                        </div>
    ...
    $("#btn-update-mutasi").click(function(event) {
    event.preventDefault();
    // $(".error").remove();
    // $(".alert").remove();
    var tanggal_mutasi = $("#tanggal_mutasi").val();
    var id_mutasi = $("#idmutasi").val();
